...
void sdf_mandelbulb(const SIMD_VEC* simd_vec_p, double params[], SIMD_MMD* simd_mmd_dists)
{
    ...
    SIMD_MMD x = simd_vec_p->x;
    SIMD_MMD y = simd_vec_p->y;
    SIMD_MMD z = simd_vec_p->z;
    ...
    dz = MULT_PD(SET1_PD(8.0), MULT_PD(m, MULT_PD(m2, MULT_PD(SQRT_PD(m), dz))));
    dz = ADD_PD(dz, SET1_PD(1.0));
    ...
    SIMD_MMD c = SUB_PD(y4, MULT_PD(SET1_PD(6.0), MULT_PD(y2,a)));
    c = ADD_PD(x4z4, c); 
    c = ADD_PD(MULT_PD(SET1_PD(2.0),x2z2), c);
    ...
    // x = vec_p[0] + 64.0*x*y*z*(x2 - z2)*d*(x4 - 6.0*x2z2 + z4)*cb;
    x = MULT_PD(SUB_PD(x2, z2), MULT_PD(SUB_PD(x4, ADD_PD(MULT_PD(SET1_PD(6.0), x2z2), z4)), cb));
    x = MULT_PD(MULT_PD(MULT_PD(SET1_PD(64.0), MULT_PD(x, MULT_PD(y, z))), d), x);
    x = ADD_PD(simd_vec_p->x, x);

    // z = vec_p[2] + 8.0*y*d*(28.0*x2z2*x4z4 - (70.0*x4 + z4)*z4 - x4*x4)*cb;
    z = MULT_PD(SUB_PD(SUB_PD(MULT_PD(MULT_PD(SET1_PD(28.0), x2z2), x4z4), MULT_PD(ADD_PD(MULT_PD(SET1_PD(70.0), x4), z4), z4)), MULT_PD(x4, x4)),  cb);
    z = MULT_PD(MULT_PD(SET1_PD(8.0), MULT_PD(y, d)), z);
    z = ADD_PD(simd_vec_p->z, z);
    ...
    *simd_mmd_dists = AND_PD(ret_mask, ret_val);
    ...
    c = SUB_PD(y4, MULT_PD(SET1_PD(6.0), MULT_PD(y2,a)));
    c = ADD_PD(x4z4, c); 
    c = ADD_PD(MULT_PD(SET1_PD(2.0),x2z2), c);
