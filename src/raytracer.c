 ...
 * HELPER - END
 * =============== */
Vector3 trace(Vector3 o, Vector3 dir, Sphere sps[], PointLight pLight, int depth)
{
    ...
    if ((depth < MAX_RAY_DEPTH) && (nearestSp->refl > 0))
    {
        ...
        Vector3 reflectedCol = trace(vec_add(phit, vec_mult1(N, bias)), reflDir, sps, pLight, depth + 1);
