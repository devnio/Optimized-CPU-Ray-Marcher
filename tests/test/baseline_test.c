...
{   
    ...
    for (unsigned int y = 0; y < height0; y++)
    {
        ...
        {
            ASSERT_EQ_FMT(image0[y * width0 * 4 + x * 4 + 0], image1[y * width0 * 4 + x * 4 + 0], "%u");
            ASSERT_EQ_FMT(image0[y * width0 * 4 + x * 4 + 1], image1[y * width0 * 4 + x * 4 + 1], "%u");
            ASSERT_EQ_FMT(image0[y * width0 * 4 + x * 4 + 2], image1[y * width0 * 4 + x * 4 + 2], "%u");
            ASSERT_EQ_FMT(image0[y * width0 * 4 + x * 4 + 3], image1[y * width0 * 4 + x * 4 + 3], "%u");
        }
    }
